...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	// load textures
	// -------------
	unsigned int woodTexture = loadTexture("resources/container2.png", true); // note that we're loading the texture as an SRGB texture
	...
	while (pWindow->isRunning == FALSE)
	{
		...
		else
		{
			...
			glBindFramebuffer(GL_FRAMEBUFFER, hdrFBO);
			glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
			glm::mat4 projection = glm::perspective(glm::radians(camera->Zoom), (GLfloat)WindowManager::SCR_WIDTH / (GLfloat)WindowManager::SCR_HEIGHT, 0.1f, 100.0f);
